...
# Not sure whether I should change this one!
# We'll try first just disabling v2 behavior globally.
...
def launch_experiment(create_runner_fn, create_agent_fn):
  ...
  # Construct subdir
  assert FLAGS.base_dir is not None
  ...
  runner = create_runner_fn(full_dir, create_agent_fn,
